...
```bash
INIT=$(node "/home/haseeb-ur-rehman/Desktop/Growth Leder/.cursor/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
```bash
node "/home/haseeb-ur-rehman/Desktop/Growth Leder/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
