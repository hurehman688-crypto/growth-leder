...
- **Global scope**: `/home/haseeb-ur-rehman/Desktop/Growth Leder/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/haseeb-ur-rehman/Desktop/Growth Leder/.codex/notes/`)
...
2. Glob `/home/haseeb-ur-rehman/Desktop/Growth Leder/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/haseeb-ur-rehman/Desktop/Growth Leder/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/haseeb-ur-rehman/Desktop/Growth Leder/.codex/notes/` — works in any directory
