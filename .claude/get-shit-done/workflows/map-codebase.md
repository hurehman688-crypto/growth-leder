...
```bash
INIT=$(node "/home/haseeb-ur-rehman/Desktop/Growth Leder/.claude/get-shit-done/bin/gsd-tools.cjs" init map-codebase)
...
```bash
node "/home/haseeb-ur-rehman/Desktop/Growth Leder/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
